...
Page
{
    ...
    Rectangle
    {
        ...
        MouseArea
        {
            ...
            onEntered:
            {
                accidentMain.color = "darkred"
                accidentMain.opacity = 1
                accTextMain.color = "White"
            }

            onExited:
            {
                accidentMain.color = "red"
                accidentMain.opacity = 0.5
                accTextMain.color = "White"
            }
    ...
    Text {
        ...
        text: qsTr("<html><b>CRASH</b></html>")
        anchors.centerIn: accidentMain
        color: "White"
        font.family: black.name
        font.pixelSize: 50
    }
